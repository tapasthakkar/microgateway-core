  ...
  return function(sourceRequest, sourceResponse, next) {
    ...
    async.series(
      ...
      function(err) {
        ...
        //get the response
        var targetRequest = _sendTargetRequest(sourceRequest, sourceResponse, plugins, startTime, correlation_id, sourceRequestPromises,
          (err, targetResponse) => {
            if (err) {
              return next(err);
            }
        ...
        requestPromise = _subscribeToSourceRequestEvents(plugins, sourceRequestPromises, sourceRequest, sourceResponse, targetRequest);
        ...
        //     }
        //   });
        //   sourceRequestPromises.push(promise);
 ...
 * @private
 */
function _sendTargetRequest(sourceRequest, sourceResponse, plugins, startTime, correlation_id, promises, cb) {
