...
module.exports.init = function init (stubConfig) {
  ...
  var baseFileName = util.format('edgemicro-%s.log', os.hostname())
  ...
  loggerFacade = {
    info: function (obj, msg) {
      var rec = _serializeLogRecord('info', obj, msg)
      logger.info(rec)
      return rec
    },
    warn: function (obj, msg) {
      var rec = _serializeLogRecord('warn', obj, msg)
      logger.warn(rec)
      return rec
    },
    error: function (obj, msg) {
      var rec = _serializeLogRecord('error', obj, msg)
      logger.error(rec);
      return rec;
    },
    stats: function (statsInfo, msg) {
      var rec = _serializeLogRecord('stats', statsInfo, msg);
      logger.info(rec);
      return rec;
    },
